import{J as E}from"./jszip.min-D_hlNinH.js";import{e as F,t as L}from"./index-B-glOZGI.js";import{d as x,p as N}from"./export-C0nPogpS.js";const U=["ggplot2","readr","dplyr"],q=new Set(["svglite","base64enc"]),I=["matplotlib","numpy","pandas","seaborn"],T=new Set(["micropip"]);function y(e){return e.replace(/[^a-z0-9_\-\s]/gi,"_").replace(/\s+/g,"_").toLowerCase()}function R(e){return[...new Set(e.map(t=>t.trim()).filter(t=>t&&!q.has(t)))]}function G(e){return`"${e.replace(/\\/g,"\\\\").replace(/"/g,'\\"')}"`}function O(e){return`required_packages <- c(${R([...U,...e]).map(G).join(", ")})
