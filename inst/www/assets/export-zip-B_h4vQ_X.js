import{J as E}from"./jszip.min-MGgvLYbS.js";import{e as F,t as L}from"./index-C8nU5hIw.js";import{d as x,p as N}from"./export-b0KzCcL6.js";const U=["ggplot2","readr","dplyr"],q=new Set(["svglite","base64enc"]),I=["matplotlib","numpy","pandas","seaborn"],T=new Set(["micropip"]);function y(e){return e.replace(/[^a-z0-9_\-\s]/gi,"_").replace(/\s+/g,"_").toLowerCase()}function R(e){return[...new Set(e.map(t=>t.trim()).filter(t=>t&&!q.has(t)))]}function G(e){return`"${e.replace(/\\/g,"\\\\").replace(/"/g,'\\"')}"`}function O(e){return`required_packages <- c(${R([...U,...e]).map(G).join(", ")})
